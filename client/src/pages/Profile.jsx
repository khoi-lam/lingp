    ...
    return (
        <div className="bg-gray-50 min-h-screen pb-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <h1 className="text-2xl font-black text-vanxuan-dark uppercase tracking-widest mb-10">Thông tin tài khoản</h1>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white rounded-[40px] p-8 lg:p-12 border border-gray-100 shadow-sm">
                        <h2 className="text-lg font-black text-vanxuan-dark uppercase tracking-widest mb-8 pb-4 border-b border-gray-50">
                            Thông tin cá nhân
                        </h2>
                        <form onSubmit={handleUpdateProfile} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="px-10 py-4 bg-vanxuan-red text-white rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-vanxuan-red/20 hover:bg-vanxuan-red/90 transition-all disabled:opacity-50"
                            >
                    ...
                    <div className="bg-white rounded-[40px] p-8 lg:p-12 border border-gray-100 shadow-sm">
                        ...
                        <form onSubmit={handleChangePassword} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="px-10 py-4 bg-vanxuan-dark text-white rounded-2xl font-black uppercase tracking-widest hover:bg-vanxuan-dark/90 transition-all disabled:opacity-50"
                            >
                    ...
                    <div className="bg-white rounded-[40px] p-8 lg:p-12 border border-gray-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="p-6 bg-gray-50 rounded-3xl text-center">
                                ...
                                <p className="text-lg font-black text-vanxuan-red uppercase">{user?.role === 'admin' ? 'Quản trị viên' : 'Khách hàng'}</p>
                            </div>
                            <div className="p-6 bg-gray-50 rounded-3xl text-center">
                                <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Ngày tham gia</p>
                                <p className="text-sm font-black text-vanxuan-dark">
