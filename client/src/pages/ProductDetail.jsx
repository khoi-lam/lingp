...
const ProductDetail = () => {
    ...
    if (!book) return (
        <div className="min-h-screen flex flex-col items-center justify-center space-y-4">
            <h2 className="text-2xl font-black text-fahasa-dark">Không tìm thấy sản phẩm</h2>
            <Link to="/shop" className="text-fahasa-red font-bold hover:underline">Quay lại cửa hàng</Link>
        </div>
    );
        ...
        <div className="bg-gray-50 min-h-screen pb-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <nav className="flex items-center space-x-2 text-xs font-bold text-gray-400 uppercase tracking-widest mb-8">
                    <Link to="/" className="hover:text-fahasa-red transition-colors">Trang chủ</Link>
                    <span>/</span>
                    <Link to="/shop" className="hover:text-fahasa-red transition-colors">Cửa hàng</Link>
                    <span>/</span>
                    <span className="text-fahasa-dark truncate max-w-[200px]">{book.title}</span>
                </nav>
                        ...
                        <div className="w-full lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <p className="text-[10px] font-black text-fahasa-red uppercase tracking-widest">{book.author}</p>
                                    <h1 className="text-3xl lg:text-4xl font-black text-fahasa-dark leading-tight">{book.title}</h1>
                                </div>

                                <div className="flex items-center space-x-4">
                                    <span className="text-3xl font-black text-fahasa-red">{book.price?.toLocaleString()}đ</span>
                                ...
                                <div className="pt-6 border-t border-gray-100 space-y-8">
                                    <div className="flex items-center space-x-6">
                                        <div className="flex items-center bg-gray-50 rounded-lg p-1 border border-gray-100">
                                            ...
                                            <span className="w-12 text-center font-black text-fahasa-dark">{quantity}</span>
                                            <button
                                        ...
                                        <button
                                            ...
                                            className="flex-1 py-4 bg-fahasa-red text-white rounded-lg font-black shadow-xl shadow-fahasa-red/20 hover:bg-fahasa-red/90 hover:-translate-y-1 transition-all active:translate-y-0 disabled:opacity-50 disabled:translate-y-0"
                                        >
                                            Thêm vào giỏ hàng
                                        </button>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="p-4 bg-gray-50 rounded-lg flex items-center space-x-4">
                                            <div className="w-10 h-10 bg-white rounded-md flex items-center justify-center text-fahasa-red shadow-sm">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs font-bold text-fahasa-dark">100% Chính hãng</p>
                                            </div>
                                        </div>
                                        <div className="p-4 bg-gray-50 rounded-lg flex items-center space-x-4">
                                            <div className="w-10 h-10 bg-white rounded-md flex items-center justify-center text-fahasa-red shadow-sm">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs font-bold text-fahasa-dark">Toàn quốc 2-4 ngày</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="flex space-x-8 border-b border-gray-100 mb-8">
                        {['info', 'shipping'].map(tab => (
                            <button
                                ...
                                className={`pb-4 text-sm font-black uppercase tracking-widest transition-all relative ${activeTab === tab ? 'text-fahasa-red' : 'text-gray-400 hover:text-gray-600'}`}
                            >
                                {tab === 'info' ? 'Chi tiết sản phẩm' : 'Thông tin vận chuyển'}
                                {activeTab === tab && <div className="absolute bottom-0 left-0 right-0 h-1 bg-fahasa-red rounded-full"></div>}
                            </button>
                        ))}
                    </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6 text-sm">
                                    <div className="flex justify-between py-3 border-b border-gray-50">
                                        ...
                                        <span className="font-black text-fahasa-dark">{book.publisher || 'N/A'}</span>
                                    </div>
                                    <div className="flex justify-between py-3 border-b border-gray-50">
                                        <span className="text-gray-400 font-bold uppercase tracking-wider text-[10px]">ISBN</span>
                                        <span className="font-black text-fahasa-dark">{book.isbn || 'N/A'}</span>
                                    </div>
                                </div>
                            </div>
                        ) : (
                ...
                {relatedBooks.length > 0 && (
                    <div className="mt-24">
                        <div className="flex justify-between items-end mb-12 px-4">
                            <div className="space-y-2">
                                <p className="text-[10px] font-black text-fahasa-red uppercase tracking-widest">Sách cùng thể loại</p>
                                <h3 className="text-3xl font-black text-fahasa-dark">Sản phẩm liên quan</h3>
                            </div>
                        </div>
                            ...
                            {relatedBooks.map(item => (
                                ...
                                >
                                    ...
                                    <div className="space-y-3 px-2">
                                        <p className="text-[10px] font-black text-fahasa-red uppercase tracking-widest truncate">{item.author}</p>
                                        <h4 className="!text-xs font-bold text-fahasa-dark line-clamp-2 h-10">{item.title}</h4>
                                        <p className="text-lg font-black text-fahasa-red">{item.price?.toLocaleString()}đ</p>
                                    </div>
                                </Link>
                            ))}
                        </div>
                    ...
                    <div className="mt-24">
                        <div className="flex justify-between items-end mb-12 px-4">
                            <div className="space-y-2">
                                ...
                                <h3 className="text-3xl font-black text-fahasa-dark">
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                                {aiRecommendations.map(item => (
                                    ...
                                    >
                                        ...
                                        <div className="space-y-3 px-2">
                                            <p className="text-[10px] font-black text-fahasa-red uppercase tracking-widest truncate">
                                                {item.author}
                                            </p>
                                            <h4 className="!text-xs font-bold text-fahasa-dark line-clamp-2 h-10">
                                                {item.title}
                                            </h4>
                                            <p className="text-lg font-black text-fahasa-red">
