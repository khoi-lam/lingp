    ...
    if (cart.length === 0) {
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
                ...
                <h2 className="text-xl font-black text-fahasa-dark uppercase tracking-widest">Giỏ hàng trống</h2>
                <p className="text-gray-400 font-bold mt-2 mb-8 text-center">Chưa có sản phẩm nào trong giỏ hàng của bạn.</p>
                <Link to="/shop" className="px-10 py-4 bg-fahasa-red text-white rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-fahasa-red/20 hover:bg-fahasa-red/90 transition-all">
                    Mua sắm ngay
                </Link>
            </div>
        );
    ...
    return (
        <div className="bg-gray-50 min-h-screen pb-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <h1 className="text-2xl font-black text-fahasa-dark uppercase tracking-widest mb-10 flex items-center space-x-4">
                    <span>Giỏ hàng</span>
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1 space-y-4">
                                    ...
                                    <div key={item._id} className="p-6 grid grid-cols-1 md:grid-cols-12 gap-6 items-center group hover:bg-gray-50/30 transition-colors">
                                        <div className="col-span-1 md:col-span-6 flex items-center space-x-6">
                                            ...
                                            <div className="space-y-1">
                                                <Link to={`/product/${item._id}`} className="text-sm font-black text-fahasa-dark hover:text-fahasa-red transition-colors line-clamp-2">
                                                    {item.title}
                                                </Link>
                                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{item.author}</p>
                                                <p className="text-sm font-black text-fahasa-red pt-1">{item.price.toLocaleString()}đ</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-span-1 md:col-span-2 flex justify-center">
                                            <div className="flex items-center bg-gray-50 rounded-xl p-0.5 border border-gray-100">
                                                <button
                                                    ...
                                                    className="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-fahasa-red transition-colors"
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M20 12H4" />
                                                    </svg>
                                                </button>
                                                <span className="w-8 text-center text-xs font-black text-fahasa-dark">{item.quantity}</span>
                                                <button
                                        ...
                                        <div className="col-span-1 md:col-span-3 text-right">
                                            <p className="text-base font-black text-fahasa-red">
                        ...
                        <Link to="/shop" className="inline-flex items-center space-x-2 text-xs font-black text-fahasa-red uppercase tracking-widest hover:underline px-4">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="w-full lg:w-96 space-y-6">
                        <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm space-y-8">
                            <h3 className="text-sm font-black text-fahasa-dark uppercase tracking-widest border-b border-gray-50 pb-4">Thanh toán</h3>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="pt-6 border-t border-gray-50 flex justify-between items-end">
                                    <span className="text-sm font-black text-fahasa-dark uppercase tracking-widest">Tổng cộng</span>
                            ...
                            <Link
                                to="/checkout"
                                className="block w-full py-5 bg-fahasa-red text-white text-center rounded-2xl font-black uppercase tracking-widest shadow-2xl shadow-fahasa-red/20 hover:bg-fahasa-red/90 hover:-translate-y-1 transition-all active:translate-y-0"
                            >
                                Xác nhận giỏ hàng
                            </Link>
                        </div>
